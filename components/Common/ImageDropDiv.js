...
import {Form, Button, Message, Segment, TextArea, Divider, Header, Icon, Image} from "semantic-ui-react"
                ...
                <Segment placeholder basic secondary>
                    ...
                    >
                        ...
                        <Segment color="green" placeholder basic>
                            <Image src={mediaPreview} size="medium" centered style={{cursor:"pointer"}} onClick={()=>inputRef.current.click()} />
                        </Segment>
                        </>
                        )}
                    </div>
