...
function LikesList({postId, trigger}) {
    ...
    return (
        <>
          <Popup on="click" onClose={()=>setLikesList([])} onOpen={getLikesList} popperDependencies={[likesList]} trigger={trigger} wide >

          {loading? <LikesPlaceHolder /> : <> {likesList.length > 0 && <div style={{overflow:"auto", maxHeight:"15rem", height:"15rem", minWidth:"210px"}}>
